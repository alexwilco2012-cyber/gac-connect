...
export const SUPPLIERS: Supplier[] = [
  ...
  },
  {
    ...
    plan: 'free',
    recentJobs: [
      'FLT with operator, 1 day — MV Choice stores load',
  ...
  },
  {
    ...
    recentJobs: [
      'Crew change, 9 pax + stores — MV Choice at anchor',
  ...
  },
  {
    ...
    recentJobs: [
      'Airport → Regent Quay, 6 crew — MV Choice on-signers',
  ...
  },
  {
    ...
    recentJobs: [
      ...
      'Quayside delivery, 6 pallets — MV Choice',
    ],
  },
  {
  ...
  },
  {
    ...
    plan: 'professional',
    recentJobs: ['Medical cover — MV Choice port call', 'Topside medic — Browne Energy shutdown'],
  },
  {
  ...
  },
  {
    ...
    plan: 'free',
    recentJobs: ['Crew provisions — MV Choice'],
  },
  {
    ...
    recentJobs: [
      'Crew rooms, 2 nights — MV Choice off-signers',
