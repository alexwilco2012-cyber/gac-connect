...
/**
 * Icon set — vendored from Lucide (https://lucide.dev) as inline SVG paths:
 * professionally drawn, optically consistent, and zero runtime dependency
 * (02: no CDN assets; the site must render offline-cached).
 *
...
/** Stroke icon, 24-unit grid, drawn at 20px unless sized. Decorative by
