...
npm run e2e              # playwright — 87 journeys across fourteen specs (installs Chromium once)
...
metric scores using Lighthouse's published weights. 441 unit tests and 87 Playwright
