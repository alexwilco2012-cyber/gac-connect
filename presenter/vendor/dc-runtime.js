...
(() => {
  ...
  // src/index.ts
  var REACT_URL = (window.__resources && window.__resources.reactUmd) || "https://unpkg.com/react@18.3.1/umd/react.production.min.js";
  var REACT_SRI = "sha384-DGyLxAyjq0f9SPpVevD6IgztCFlnMF6oW/XQGmfe+IsZ8TqEiDrcHkMLKI6fiB/Z";
  var REACT_DOM_URL = (window.__resources && window.__resources.reactDomUmd) || "https://unpkg.com/react-dom@18.3.1/umd/react-dom.production.min.js";
  ...
  function loadScript(src, integrity) {
    return new Promise((resolve2, reject) => {
      ...
      const s = document.createElement("script");
      s.src = src;
      if (integrity && !/^(blob|data):/.test(src)) { s.integrity = integrity; s.crossOrigin = "anonymous"; }
      s.async = false;
      s.onload = () => resolve2();
